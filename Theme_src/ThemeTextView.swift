...
extension UITextView {
    ...
    @objc open func putTheme()  {
        if withTheme {
            self.font = UIFont.init(name: UITextView.theme_fontName, size: UITextView.theme_fontSize)
            self.textColor = UITextView.theme_textColor
            self.backgroundColor = UITextView.theme_background
        }
    }
